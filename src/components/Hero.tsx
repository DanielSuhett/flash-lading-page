...
import { Github, GitPullRequestDraft, Zap } from "lucide-react";
      ...
      <div className="hero-content text-center py-16 max-w-4xl">
        <div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="https://github.com/DanielSuhett/flash-lading-page/pull/1"
              target="_blank"
              rel="noopener noreferrer"
              className="btn btn-accent btn-lg"
            >
              <GitPullRequestDraft size={20} className="mr-2" />
              {t("hero.ctaTertiary")}
            </a>
